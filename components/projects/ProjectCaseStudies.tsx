  ...
  return (
    <div className="relative mx-auto hidden h-[180px] w-[180px] shrink-0 sm:block">
      <div className="absolute inset-0 flex items-center justify-center" aria-hidden="true">
        <div className="h-[150px] w-[150px] rounded-full border border-dashed" style={{ borderColor: `${colors.text === 'text-accent' ? '#FF8906' : ''}` }} />
      </div>
...
function CaseStudyPanel({ study, index }: { study: CaseStudy; index: number }) {
  ...
  return (
    <motion.div
      ...
      style={{ borderLeftWidth: 4, borderLeftColor: colors.text === 'text-accent' ? '#FF8906' : undefined }}
    >
...
export default function ProjectCaseStudiesShowcase() {
  ...
  return (
    <section
      ...
      style={{
        background:
          'radial-gradient(circle at 20% 20%, rgba(255,137,6,0.04), transparent 40%), radial-gradient(circle at 80% 80%, rgba(16,185,129,0.04), transparent 40%), #FFFFFF',
      }}
    >
